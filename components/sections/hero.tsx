...
export function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#F3C0BF]">
      ...
      <div className="relative z-10 w-full container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 flex flex-col items-center justify-center min-h-screen pt-20 sm:pt-24 md:pt-28 pb-10 sm:pb-12 md:pb-16">
        ...
        >
          ...
          <div className="pt-3 sm:pt-4 md:pt-5 flex flex-col gap-3 sm:gap-4 items-center max-w-2xl mx-auto w-full px-4">
            ...
            <a
              href="#guest-list"
              className={`${cormorant.className} group relative flex-1 sm:min-w-[200px] md:min-w-[220px] rounded-lg overflow-hidden transition-all duration-300 hover:-translate-y-1 focus-visible:-translate-y-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#EBC1CB]/70`}
              style={{
                backgroundColor: "#BC677C",
                boxShadow: "0 10px 24px rgba(188,103,124,0.4)",
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.backgroundColor = "#E2AAAD";
                e.currentTarget.style.boxShadow = "0 12px 28px rgba(188,103,124,0.5)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.backgroundColor = "#BC677C";
                e.currentTarget.style.boxShadow = "0 10px 24px rgba(188,103,124,0.4)";
              }}
            >
